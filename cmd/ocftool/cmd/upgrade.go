...
func NewUpgrade() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "upgrade",
		Short: "Upgrades Voltron",
		Long:  "Use this command to upgrade the Voltron version on a cluster.",
		Example: heredoc.WithCLIName(`
			# Upgrade Voltron components to newest available version
			<cli> upgrade

			# Upgrade Voltron components to 0.1.0 version
	...
	flags := cmd.Flags()
	flags.StringVar(&opts.Version, "version", upgrade.LatestVersionTag, "Voltron version")
