...
type hubCli interface {
	//FindInterfaceRevision(ctx context.Context, ref gqlpublicapi.InterfaceReference) (*gqlpublicapi.InterfaceRevision, error)
...
func NewValidator(hubCli hubCli) *Validator {
...
func (c *Validator) HasRequiredProp(schemas SchemaCollection) (bool, error) {
...
func (c *Validator) LoadIfaceInputParametersSchemas(ctx context.Context, iface *gqlpublicapi.InterfaceRevision) (SchemaCollection, error) {
	var (
		parametersSchemas        = SchemaCollection{}
...
func (c *Validator) LoadIfaceInputTypeInstanceRefs(_ context.Context, iface *gqlpublicapi.InterfaceRevision) (TypeRefCollection, error) {
...
func (c *Validator) ValidateParameters(paramsSchemas SchemaCollection, parameters map[string]string) (validate.ValidationResult, error) {
...
func (c *Validator) ValidateTypeInstances(allowedTypes TypeRefCollection, gotTypeInstances []*gqlengine.InputTypeInstanceData) (validate.ValidationResult, error) {
...
func (*Validator) typeRefToKey(ref gqlpublicapi.TypeReference) string {
	return fmt.Sprintf("%s:%s", ref.Path, ref.Revision)
}

func (*Validator) keyToTypeRef(ref string) gqlpublicapi.TypeReference {
