...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "TypeInstance.createdBy":
		if e.complexity.TypeInstance.CreatedBy == nil {
			break
		}

		return e.complexity.TypeInstance.CreatedBy(childComplexity), true
...
type Mutation {
  ...
  updateTypeInstances(in: [UpdateTypeInstancesInput]!): [TypeInstance!]!
    @cypher(
      ...
      CREATE (tir: TypeInstanceResourceVersion {resourceVersion: latestRevision.resourceVersion + 1, createdBy: item.typeInstance.createdBy})
      CREATE (ti)-[:CONTAINS]->(tir)
...
func (ec *executionContext) _TypeInstance_createdBy(ctx context.Context, field graphql.CollectedField, obj *TypeInstance) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _TypeInstance(ctx context.Context, sel ast.SelectionSet, obj *TypeInstance) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "createdBy":
			out.Values[i] = ec._TypeInstance_createdBy(ctx, field, obj)
		case "typeRef":
