...
func (h *fakeHub) FindInterfaceRevision(ctx context.Context, ref graphql.InterfaceReference, opts ...public.InterfaceRevisionOption) (*graphql.InterfaceRevision, error) {
	return &graphql.InterfaceRevision{}, nil
}
