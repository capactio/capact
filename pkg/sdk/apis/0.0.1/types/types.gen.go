...
type Metrics struct {
	Dashboards []DashboardElement `json:"dashboards,omitempty"`// Metrics dashboards
...
func (x *DashboardElement) UnmarshalJSON(data []byte) error {
	x.AnythingArray = nil
	x.DashboardClass = nil
	var c DashboardClass
...
func (x *DashboardElement) MarshalJSON() ([]byte, error) {
	return marshalUnion(x.Integer, x.Double, x.Bool, x.String, x.AnythingArray != nil, x.AnythingArray, x.DashboardClass != nil, x.DashboardClass, false, nil, false, nil, true)
}
